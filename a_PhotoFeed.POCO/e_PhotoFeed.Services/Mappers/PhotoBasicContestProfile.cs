...
{
    public class PhotoBasicContestProfile: Profile
    {
        public PhotoBasicContestProfile()
        {
            CreateMap<PhotoBasicContest, PhotoBasicContestDTO>()
                ...
                .ForMember(dest => dest.IdBasicContest, src => src.MapFrom(x => x.IdBasicContest))
                .ForMember(dest => dest.IdPhotoBasicContest, src => src.MapFrom(x => x.IdPhotoBasicContest))
                .ForMember(dest => dest.Photo, src => src.MapFrom(x => x.Photo))
                .ForMember(dest => dest.Rating, src => src.MapFrom(x => x.Rating));

            CreateMap<PhotoBasicContestDTO, PhotoBasicContest>()
                .ForMember(dest => dest.IdUser, src => src.MapFrom(x => x.IdUser))
                .ForMember(dest => dest.Copyrighted, src => src.MapFrom(x => x.Copyrighted))
                .ForMember(dest => dest.DatePosted, src => src.MapFrom(x => x.DatePosted))
                .ForMember(dest => dest.Description, src => src.MapFrom(x => x.Description))
                ...
                .ForMember(dest => dest.Photo, src => src.MapFrom(x => x.Photo))
                .ForMember(dest => dest.Rating, src => src.MapFrom(x => x.Rating))
                .ForMember(dest => dest.ContestBasic, src => src.Ignore())
